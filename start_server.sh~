...
if [ "$(uname)" == "Darwin" ]; then
    javac -cp server/servlet-api.jar:server/org.json.jar server/WEB-INF/classes/servlets/Companies.java && java -jar
 server/winstone.jar server/WEB-INF/lib/org.json.jar --webroot server        
